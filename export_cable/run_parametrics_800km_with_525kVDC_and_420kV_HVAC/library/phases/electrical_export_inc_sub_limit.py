...
class ElectricalDesignIncSub(CableSystem):  # increased substation carry limit to a bit higher than the 420 kV HVAC carry limit so that only 1 substation is built.
    """
    ...
    def detailed_output(self):
        ...
        _output = {
            **self.design_result,
            ...
            "onshore_cost": self.onshore_cost,
            "onshore_construction": self.onshore_construction,
            "onshore_compensation": self.onshore_compensation,
            "mpt_cost": self.mpt_cost,
            "ais_cost": self.ais_cost
        }
    ...
    def calc_onshore_cost(self):
        ...
        if self.cable.cable_type == "HVDC-monopole":
            ...
            print(self.onshore_construction)
            self.onshore_compensation = 0
        else:
